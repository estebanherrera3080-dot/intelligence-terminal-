-- ============================================
-- JARDIN SECRETO - DATABASE INITIALIZATION
-- ============================================
...
-- CREATE USER jardin_app WITH PASSWORD 'change_me_in_production';
-- GRANT CONNECT ON DATABASE jardinsecreto TO jardin_app;
-- GRANT USAGE ON SCHEMA public TO jardin_app;
-- GRANT ALL TABLES IN SCHEMA public TO jardin_app;
