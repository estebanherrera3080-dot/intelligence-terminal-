...
```bash
# Clonar repositorio
git clone <your-repo-url> jardinsecreto
cd jardinsecreto
...
docker-compose exec postgres psql -U postgres -d jardinsecreto \
...
# Crear base de datos
psql -U postgres -c "CREATE DATABASE jardinsecreto;"

# Cargar schema
psql -U postgres -d jardinsecreto -f database/init.sql

# Habilitar TimescaleDB
psql -U postgres -d jardinsecreto \
...
psql postgresql://postgres:postgres@localhost:5432/jardinsecreto
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/jardinsecreto
...
# Manual
# 1. PostgreSQL
psql -U postgres -d jardinsecreto -c "SELECT version();"
